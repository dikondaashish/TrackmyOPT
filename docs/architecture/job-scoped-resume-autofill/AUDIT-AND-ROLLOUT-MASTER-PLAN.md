...
| Non-blocking review/download/edit/regenerate UI   | **Met**     | Review controller/actions: `apps/extension/src/cover-letter-review.ts`                                                                                                                                                                     | Live-controller invalidation/recompile test: `apps/extension/tests/cover-letter-review-ui.test.ts` |
...
| Criterion                                         | Status      | Implementation evidence                                                                                                                                                                                        | Test evidence / gap                                                                                                                                                      |
| ------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Section-aware history mappings                    | **Met**     | Production ATS classifier: `apps/extension/src/ats-prefill-adapters.ts`; fill engine: `apps/extension/src/repeatable-record-engine.ts`                                                                      | Workday/Greenhouse fixtures and two-record engine tests: `apps/extension/tests/ats-prefill-adapters.test.ts`, `apps/extension/tests/repeatable-record-engine.test.ts`      |
...
| Stable display-order mapping                      | **Met**     | DOM ordering and record indices: `apps/extension/src/repeatable-record-engine.ts`                                                                                                                              | Employer-row pairing: `apps/extension/tests/repeatable-record-engine.test.ts`                                                                                            |
...
| Skills do not widen history matching              | **Met**     | Skills stay a separate section/field in `apps/extension/src/ats-prefill-adapters.ts`                                                                                                                            | Default-off skills tests remain separate from history tests                                                                                                              |
| Remaining records shown; Add another stays manual | **Met**     | Fill outcome and user copy live in `apps/extension/src/repeatable-record-engine.ts` and `apps/extension/src/prefill-coverage.ts`                                                                                | No host click and remaining-row assertions: `apps/extension/tests/repeatable-record-engine.test.ts`                                                                      |
| Referral/website/manager organization traps       | **Met**     | Shared `ORG_TRAP_RE` in `apps/extension/src/easy-apply-matchers.ts` is used by `apps/extension/src/ats-prefill-adapters.ts`                                                                                     | Adapter parity assertions: `apps/extension/tests/ats-prefill-adapters.test.ts`                                                                                            |
...
`apps/extension/tests/ats-prefill-adapters.test.ts`.
