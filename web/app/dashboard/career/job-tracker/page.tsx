            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
                ...
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center border-2 border-dashed border-border rounded-xl bg-card p-8">
                    ...
                    <p className="text-muted-foreground max-w-md">
                        Organize your job search with our Kanban-style tracker. Manage applications, interviews, and offers in one place.
                    </p>
                    <div className="mt-8 px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-sm font-medium">
                        Coming Soon
                    </div>
                </div>
            </div>
