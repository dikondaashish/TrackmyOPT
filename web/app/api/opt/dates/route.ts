...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('GET /api/opt/dates error:', error);
    return NextResponse.json(
...
/**
 * POST - Save OPT dates with flexible validation
 */
export async function POST(req: NextRequest) {
  try {
    ...
    // Upsert opt_status with flexible defaults
    ...
    console.error('POST /api/opt/dates error:', error);
    return NextResponse.json(
