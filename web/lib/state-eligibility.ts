...
export function calculateEligibility(params: EligibilityParams): EligibilityResult {
    ...
    if (config.tier === 'TIER_3') {
        return {
            ...
            recommendedAction: "Use University SHIP ($1,400-$4,500/yr) or private insurance (ISO: from $31/mo).",
            showStateProgram: false,
        };
    }
        ...
        if (config.tier === 'TIER_2') {
            ...
            if (config.eligibleAdult19Plus === 'no') {
                return {
                    ...
                    recommendedAction: `Use University SHIP or private insurance (ISO: from $31/mo, Compass: similar).`,
                    showStateProgram: false,
                };
            }
        }
