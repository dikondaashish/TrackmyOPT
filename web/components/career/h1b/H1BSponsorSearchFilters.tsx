...
export function H1BSponsorSearchFilters({ filters, onFilterChange, allIndustries }: H1BSponsorSearchFiltersProps) {
    ...
    const displayIndustries = allIndustries && allIndustries.length > 0
        ? ["All", ...allIndustries.filter(i => i !== "All").sort()]
        : INDUSTRY_OPTIONS;
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm mb-6">
            <div className="flex flex-col md:flex-row gap-4">
                {/* Search Bar - Larger and Prominent */}
            ...
            {(filters.status !== "All" || filters.trend !== "All" || filters.industry !== "All") && (
                <div className="flex items-center gap-2 mt-4 text-xs text-gray-500 animate-in fade-in slide-in-from-top-2">
                    ...
                    <button
                        onClick={() => onFilterChange({ ...filters, status: "All", trend: "All", industry: "All" })}
