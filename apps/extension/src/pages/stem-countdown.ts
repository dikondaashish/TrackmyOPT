...
export async function renderStemCountdown(
  ...
  content.innerHTML = `
    ...
    <div style="${toolSurfaceCard('green')};border-radius:20px;padding:16px;margin-bottom:10px;position:relative;overflow:hidden;">
      ${!isPremium ? `
      ...
      <div style="text-align: center; margin-bottom: 12px;">
        <div style="font-size: 16px; font-weight: 800; margin-bottom: 4px; display: flex; align-items: center; justify-content: center; gap: 6px;">${icon('mail', 18, 'currentColor')} Daily Reminders <span style="font-size: 13px; opacity: 0.9;">(9:00 AM ET)</span></div>
