...
function createDatePicker(
  ...
  function renderCalendar() {
    ...
    clearBtn.addEventListener('mouseenter', () => { clearBtn.style.background = 'var(--tool-orange-surface)'; });
    ...
    todayBtn.addEventListener('mouseenter', () => { todayBtn.style.background = 'var(--tool-orange-surface)'; });
