                            ...
                            <div className="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                        <span className="font-semibold text-gray-900 dark:text-white">Example company</span>
                                        <span>• Los Gatos, CA</span>
                                    </div>
                                </div>
                                <div className="w-10 h-10 bg-blue-600 rounded flex items-center justify-center text-white font-bold">TM</div>
                            </div>
                ...
                >
                    <div className="p-4 bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                        <div className="flex items-center gap-2 mb-1">
                            <Image src="/TrackMyOPT Logo/Favicon.png" width={20} height={20} className="w-5 h-5 bg-white rounded-full" alt="TrackMyOPT" />
                        ...
                        <h4 className="font-bold text-lg mt-2">Application tools</h4>
                    ...
                    <div className="p-4 space-y-4 flex-1 overflow-y-auto">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className="bg-gray-50 dark:bg-zinc-800 p-2 rounded-lg text-center">
                                <p className="text-xl font-bold text-gray-900 dark:text-white">Manual</p>
                                <p className="text-[10px] text-gray-500">Final submit</p>
                            </div>
                        </div>

                        {/* Trend Chart Mock */}
                        <div>
                            <p className="text-xs font-semibold text-gray-500 mb-2">Application progress</p>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-300">
                                ...
                                Sponsorship is not stated in this example listing.
                            </div>
                            <div className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-300">
                                <CheckCircle2 className="w-3.5 h-3.5 text-green-500 mt-0.5 flex-shrink-0" />
                                Prefill only the fields you choose, then review them.
                            </div>
                        </div>
                    </div>
