...
export function FilingDetailModal({ filing, isOpen, onClose }: FilingDetailModalProps) {
    ...
    return (
        <div
            className="fixed inset-0 left-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200"
            onClick={onClose}
        >
            <div
                className="bg-white dark:bg-gray-900 w-full max-w-5xl max-h-[85vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-4 duration-300 border border-gray-200 dark:border-gray-700"
