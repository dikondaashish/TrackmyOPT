...
export function EmployerEvidencePanel({
  ...
  if (!match?.canonical_h1b_sponsor_id || !['auto', 'confirmed'].includes(match.review_status)) {
    return (
      <section className="border-t border-slate-950/10 pt-3 dark:border-white/10" aria-label="Employer evidence unavailable">
        <div className="flex gap-3">
          <span className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-slate-950/10 text-slate-700 dark:bg-white/10 dark:text-slate-200"><ShieldQuestion className="size-4" aria-hidden="true" /></span>
  ...
  return (
    <section className="border-t border-slate-950/10 pt-3 dark:border-white/10" aria-label="Employer evidence">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-3">
          <span className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-slate-950 text-white dark:bg-white dark:text-slate-950"><Building2 className="size-4" aria-hidden="true" /></span>
        ...
        <Link
          ...
          className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl px-2 py-2 text-sm font-semibold text-blue-800 transition-colors hover:bg-white/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 dark:text-blue-200 dark:hover:bg-slate-950/50"
        >
      ...
      <details className="group mt-3 text-sm">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 rounded-xl px-2 py-2 font-semibold text-slate-800 transition-colors hover:bg-white/45 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 dark:text-slate-100 dark:hover:bg-slate-950/40">
        ...
        <div className="mt-3 grid gap-3 border-t border-slate-950/10 pt-3 dark:border-white/10 sm:grid-cols-2">
          ...
          <div className="border-t border-slate-950/10 pt-3 text-slate-800 sm:border-l sm:border-t-0 sm:pl-3 sm:pt-0 dark:border-white/10 dark:text-slate-200">
