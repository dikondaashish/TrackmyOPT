...
export const COMPLIANCE_GUIDES: Record<string, ComplianceGuide> = {
  ...
  "laid-off-on-stem-opt": guide(
    ...
    [
      ...
      { heading: "Understand the 150-day limit", paragraphs: ["The 150-day figure is cumulative across initial post-completion OPT and the 24-month STEM extension. STEM OPT adds 60 days; it does not reset the 90 days used during initial OPT. Count the calendar-day gap from the first day after the last qualifying employment period.", "Use TrackMyOPT’s [STEM-aware unemployment clock](/dashboard/opt-tools/opt-clock) and keep your initial OPT and STEM OPT dates in the same timeline."] },
  ...
  "can-you-start-work-before-opt-ead-arrives": guide(
    ...
    [
      ...
      { heading: "What to do if the start date has passed", paragraphs: ["Tell the employer you cannot begin until the work-authorization condition is satisfied. Ask HR to update the planned start date in writing, and keep the email. Track the USCIS case and the unemployment timeline separately.", "Use the [OPT unemployment clock](/dashboard/opt-tools/opt-clock) to record the authorization start date and the actual first qualifying work date. If the delay creates a serious concern, speak with your DSO promptly rather than waiting for day 90."] },
    ...
    [{ label: "ICE practical training guidance", href: ICE_PRACTICAL }, { label: "USCIS EAD non-delivery inquiry", href: USCIS_NON_DELIVERY }, { label: "TrackMyOPT OPT clock", href: "https://www.trackmyopt.com/dashboard/opt-tools/opt-clock" }],
    "unemployment",
