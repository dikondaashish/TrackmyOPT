import { Bell, Clock, Shield, FileCheck, Briefcase, Zap } from 'lucide-react';
import {
...
const basePricingFaqs = [
  ...
  },
  {
    ...
    a: `Limited-time offer: eligible accounts can start Pro for $${PRO_PAID_INTRO_PRICE.toFixed(2)} for the first ${PRO_TRIAL_DAYS} days. It is a paid introductory period, not a free trial, and then renews at $${PLAN_PRICES.pro.month.toFixed(2)}/month or $${PLAN_PRICES.pro.year.toFixed(2)}/year unless canceled.`,
  },
  {
...
export const testimonials = [
  {
    quote:
      'I tracked unemployment days in a spreadsheet and almost lost count. Pro emailed me at day 75 — I had time to log my new job and stay organized.',
    name: 'Priya S.',
    role: 'CS Graduate',
  ...
  {
    quote:
      'Pro caught my USCIS status change the same morning it posted. I could review it and talk to my DSO right away instead of finding out days later.',
    name: 'Wei L.',
    role: 'ECE Graduate',
  ...
  {
    quote:
      'On STEM OPT I had two employers to track. TrackMyOPT Pro keeps my unemployment days and reminders in one place — I recommend it to every international student I know.',
    name: 'Ravi M.',
...
export const whyPremiumReasons = [
  {
    ...
    description:
      '9:00 AM ET emails before I-765 filing windows, unemployment limits, and STEM reporting dates.',
  ...
  },
  {
    ...
    description:
      'Automatic counting with alerts as you approach the 90- or 150-day limits.',
  ...
  },
  {
    ...
    description:
      'Your case checked each morning. Email when we detect a status change on scheduled checks.',
  ...
  },
  {
    ...
    description:
      'Store your I-20, EAD, passport, and tax documents in one encrypted vault with expiry reminders. Always ready for employer audits.',
  ...
  },
  {
    ...
    description:
      'AI resume tailoring, ATS analysis, job tracking, application prefill, and full H-1B sponsor data in one workflow.',
  ...
  },
  {
    ...
    description:
      'I-983 training plan tracking, E-Verify employer verification, and 150-day unemployment monitoring across the full 36-month OPT period.',
