...
it('describes historical approvals without promising an imminent decision or a live queue', () => {
  const prediction: CommunityEstimate = {
    cohortSize: 20, medianDays: 60, p25Days: 45, p75Days: 75, fastestDays: 10,
    estimatedDecisionRange: ['2026-09-23', '2026-09-23'], distribution: [],
    cohortPosition: { ahead: 18, behind: 2, percentile: 90 }, approvalsLast24h: 0,
    matchLevel: 'pp', caseKind: 'initial_opt', serviceCenter: null,
    premiumProcessing: false, sourceNote: 'Community reports',
  };
  ...
  expect(screen.getByText('Historical approvals taking longer')).toBeInTheDocument();
