      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h2
              id="case-action-center-title"
              className="mt-1 text-base font-semibold text-foreground"
            >
              {plan.title}
            </h2>
            <p className="mt-1 max-w-prose text-sm leading-6 text-foreground/80">
              {plan.summary}
            </p>
          </div>
        </div>
              ...
              {plan.actions.map((action) => {
                ...
                return action.external ? (
                  <Button
                    ...
                    asChild
                    variant="outline"
                      className="h-auto min-h-11 max-w-full justify-between gap-3 whitespace-normal py-3"
                  >
                    <a
                      href={action.href}
                      target="_blank"
        ...
        <div className="mt-2 flex flex-col gap-1 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>
            Planning guidance only. Your USCIS notice and online account
            control.
          </p>
          <a
