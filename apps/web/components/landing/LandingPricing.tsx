    ...
    const plans: PricingPlan[] = [
        {
            ...
            features: [
                ...
                { label: "Interactive Checklists", included: true },
                { label: "Health Insurance Guide", included: true },
                { label: "Tax Filing Guide", included: true },
                { label: "Profile Management", included: true },
                { label: "Premium Job Board (Pro)", included: false },
                { label: "AI Resume Tools (Pro)", included: false },
            ],
            recommended: false,
        },
        {
            ...
            features: [
                ...
                { label: "Automated USCIS Tracker", included: true },
                { label: "Job Tracker CRM (Kanban)", included: true },
                { label: "Application ATS Scanner", included: true },
                { label: "Advanced Document Vault", included: true },
                { label: "Passcode Protection", included: true },
                { label: "Daily Email Reminders", included: true },
            ],
            recommended: true,
            badge: "Most Popular",
        },
