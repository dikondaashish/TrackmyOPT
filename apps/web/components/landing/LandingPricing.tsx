    ...
    const plans: PricingPlan[] = [
        {
            ...
            features: [
                { label: "OPT/STEM Calculators (Daily 9AM Emails)", included: true },
                { label: "Unemployment Clock (90/60 Day Tracking)", included: true },
                { label: "USCIS Case Tracker (Basic Status Check)", included: true },
                { label: "H1B Sponsor Intelligence (100 Companies)", included: true },
                { label: "Job Application Tracker (Track 5 Jobs)", included: true },
        ...
        },
        {
            ...
            features: [
                ...
                { label: "Automated USCIS Tracker (Every 6hrs + Alerts)", included: true },
                { label: "H1B Sponsor Intelligence (Unlimited)", included: true },
