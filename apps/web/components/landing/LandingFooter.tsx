...
} from "@/components/landing/LandingFooterClient";
...
const CloudflareLogo = () => (
  <svg viewBox="0 0 48 24" className="h-6 w-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M32.5 4C28.4 4 25.1 7.3 25.1 11.4C25.1 11.6 25.1 11.8 25.1 12H25C20.6 12 17 15.6 17 20H42C45.3 20 48 17.3 48 14C48 10.7 45.3 8 42 8C41.8 8 41.6 8 41.4 8.1C40.3 5.7 37.9 4 35 4H32.5Z"
      fill="#F38020"
    />
    <path
      d="M17 20H6C2.7 20 0 17.3 0 14C0 10.7 2.7 8 6 8C6.2 8 6.4 8 6.6 8C7.7 5.7 10.1 4 13 4H15.5C19.6 4 22.9 7.3 22.9 11.4C22.9 11.6 22.9 11.8 22.9 12H23C27.4 12 31 15.6 31 20"
      fill="#FAAD3F"
    />
  </svg>
);
...
const StripeBadge = () => (
  <div className="flex items-center gap-1.5 bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 px-2.5 py-1 rounded-full">
    <span className="text-[9px] font-semibold text-violet-800 dark:text-violet-200 uppercase tracking-wide">
      Payments by Stripe
    </span>
  </div>
);
...
const SslLogo = () => (
  <div className="flex items-center gap-1.5 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 px-2 py-1 rounded-full">
    ...
    <span className="text-[9px] font-bold text-green-700 dark:text-green-300 uppercase tracking-wide">
      SSL Secure
    </span>
  </div>
);
    ...
    <footer className="bg-gray-50 dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5 md:gap-8 lg:gap-12">
          ...
          <div>
            <h4 className="mb-4 font-semibold text-gray-900 dark:text-white">Guides</h4>
            <ul className="space-y-1 md:space-y-3">
