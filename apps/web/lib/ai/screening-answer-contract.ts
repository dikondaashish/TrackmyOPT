...
export interface ScreeningQuestionDraftResponse extends AiGenerationLimitState {
  ok: boolean; questionHash: string; draft?: string; sourceContentHash?: string;
  error?: 'sensitive'|'insufficient_context'|'limit'|'generation_failed'|'ai_daily_limit_reached'|'ai_item_regeneration_limit_reached';
}
