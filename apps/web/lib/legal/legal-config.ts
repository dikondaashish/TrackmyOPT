...
export const EXTENSION_AUTOFILL_PRIVACY_DISCLOSURE =
  "When you explicitly choose Prefill, Continuous, or Guided Autopilot, the Chrome extension may read the open application form and place eligible information from your TrackMyOPT profile and the active job-scoped generated resume into empty fields. A generated resume artifact is kept in extension session storage for up to 30 minutes and is invalidated when its job URL, company, or role changes. Optional AI screening drafts and cover letters send the current job description and the active generated-resume snapshot to our AI provider; drafts require your review and are never generated for sensitive questions. You may optionally save work-authorization, visa, sponsorship, citizenship, salary, date-of-birth, sex/gender, race/ethnicity, veteran, disability, and EEO answers in a separate server-side record protected with authenticated encryption. These answers are never guessed or sent to AI, browser sync storage, logs, or analytics. The extension loads saved answers into a private review panel, and it cannot use them until you approve them for the current application. You can edit or delete saved answers in Settings. Guided Autopilot may click narrowly allowlisted non-submit Next, Continue, or Done controls after required fields are complete, but it stops at Review and never clicks Submit, Apply, Finish, or another final application action. The extension does not replace non-empty fields or existing files or answer Social Security number questions. Autofill analytics contain only bounded counts, feature states, adapter and mode identifiers, navigation outcomes, and content-free error categories—not resume, answer, field, employer, school, job-title, URL, hash, file content, or private application answers.";

export const EXTENSION_AUTOFILL_SUPPORT_NOTICE =
  "Current release scope includes explicit and Continuous profile/resume/history prefill, optional skills, review-required AI screening drafts, saved answer reuse, real generated cover-letter PDFs, and opt-in Guided Autopilot. Optional private application answers are encrypted separately, never guessed or processed by AI, and require approval in the extension for every application before filling. Guided Autopilot can advance safe Next/Continue steps, pauses for required or review-needed answers, and always stops before final submission. Press Escape or Stop at any time. TrackMyOPT never submits an application; review every field and attachment yourself.";
