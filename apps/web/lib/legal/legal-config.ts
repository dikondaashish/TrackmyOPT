...
export const EXTENSION_AUTOFILL_PRIVACY_DISCLOSURE =
  "When you explicitly choose Prefill, Continuous, or Guided Autopilot, the Chrome extension may read the open application form and place eligible information from your dedicated job-portal prefill profile and the active job-scoped generated resume into empty fields. The dedicated profile may include job-application contact information, address, LinkedIn, GitHub, and website details and is separate from your normal TrackMyOPT account profile. A generated resume artifact is kept in extension session storage for up to 30 minutes and is invalidated when the normalized job URL, company, or role changes. Optional AI screening drafts and cover letters send the current job description and the active generated-resume snapshot to our AI provider; drafts require your review and are never generated for sensitive questions. You may optionally save work-authorization, visa, sponsorship, citizenship, annual or hourly compensation, in-person/relocation/start/transportation/accommodation preferences, date-of-birth, sex/gender, race/ethnicity, veteran, disability, and EEO answers in a separate server-side record protected with authenticated encryption. You may also save a limited number of employer job-portal login credentials in that encrypted record. Each login is restricted to one exact hostname; the extension does not send it to subdomains or a different portal, never places it in browser sync storage, and keeps the password masked in its review panel. Because TrackMyOPT's server must decrypt a saved portal password to provide the autofill feature, this credential storage is not end-to-end encryption and should not be used for your TrackMyOPT password or a reused primary password. Credentials and private answers are never guessed or sent to AI, logs, or analytics. The extension loads saved private data into a review panel, and it cannot use it until you approve it for the current application. When filled, the selected credential or answer is disclosed to the employer or applicant-tracking system operating that exact page. You can edit or delete saved private data on the Chrome Job Prefill page. Guided Autopilot may click narrowly allowlisted non-submit Next, Continue, or Done controls after required fields are complete, but it stops at Review and never clicks Submit, Apply, Finish, or another final application action. The extension does not replace non-empty fields or existing files, fill password-change or one-time-code fields, or answer Social Security number questions. Autofill analytics contain only bounded counts, feature states, adapter and mode identifiers, navigation outcomes, and content-free error categories—not resume, answer, field, employer, school, job-title, URL, hash, file content, credentials, or private application answers.";

export const EXTENSION_AUTOFILL_SUPPORT_NOTICE =
  "Free includes Step-by-step profile/resume/history prefill, optional skills, review-required private answers and exact-site portal logins, 5 AI screening drafts per month, and 1 AI cover letter per month. Pro adds Continuous filling, opt-in Guided Autopilot, and higher daily AI access. Optional private application data is encrypted separately, never guessed or processed by AI, and requires approval in the extension for every application before filling. Portal passwords are exact-host only, remain masked in the extension panel, and are skipped on password-change, one-time-code, and TrackMyOPT pages. Guided Autopilot can advance safe Next/Continue/Done steps, pauses for required or review-needed answers, and always stops before final submission. Press Escape or Stop at any time. TrackMyOPT never submits an application; review every field and attachment yourself.";
