...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'TrackMyOPT - OPT Tools for F-1 Students',
    description: 'Track OPT deadlines, find H-1B jobs, and secure your future. Join 3,000+ people who have signed up for TrackMyOPT.',
    creator: '@trackmyopt',
    images: ['/og-image.jpg'],
  },
  robots: {
