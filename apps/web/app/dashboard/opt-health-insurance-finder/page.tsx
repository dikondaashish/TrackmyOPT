  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-background dark:to-background">
        ...
        <div className="max-w-5xl mx-auto px-4 pt-6 pb-6 sm:pt-8 sm:pb-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-foreground tracking-tight mb-4">
              ...
              <span className="block text-blue-600 dark:text-blue-400">Starting from $0/month</span>
            </h1>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-12 px-4 pr-10 rounded-xl border border-slate-200 dark:border-border bg-slate-50 dark:bg-muted text-slate-900 dark:text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none transition-all"
                >
                  {US_STATES.map((s) => (
                    <option key={s.value} value={s.value}>{s.label}</option>
                  ))}
                </select>
                <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-muted-foreground pointer-events-none" />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="0"
                min="0"
                className="w-full h-12 px-4 rounded-xl border border-slate-200 dark:border-border bg-slate-50 dark:bg-muted text-slate-900 dark:text-foreground placeholder:text-slate-400 dark:placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
              <p className="text-xs text-slate-500 dark:text-muted-foreground mt-1.5">If you are doing an internship or voluntary job and not getting paid, enter 0</p>
            </div>
            ...
            <button
              ...
              className="w-full h-12 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 dark:disabled:bg-muted disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 mt-2"
            >
              {isLoading ? (
      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-foreground text-center mb-8">
      ...
      {/* Partners */}
      <div className="border-t border-slate-100 dark:border-border bg-slate-50/50 dark:bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <p className="text-center text-sm text-slate-500 dark:text-muted-foreground mb-6">Our Trusted Partners</p>
