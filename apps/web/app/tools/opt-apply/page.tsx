...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.trackmyopt.com/tools/opt-apply',
    siteName: 'TrackMyOPT',
    type: 'article',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.trackmyopt.com/tools/opt-apply',
  },
};
...
const jsonLd = {
  ...
  step: [
    ...
    },
    {
      '@type': 'HowToStep',
      name: 'Pay Filing Fee',
      text: 'Check the USCIS fee calculator for the current Form I-765 filing fee and your filing method.',
      position: 4,
    },
    {
      '@type': 'HowToStep',
      ...
      >
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
            Plan your filing window
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
            Start planning up to 90 days before your program end date. Current
            rules and transitional provisions can change the post-program filing
            window. Confirm your I-94 and applicable deadline with your DSO; the
            historical 60-day window is not universal. The SEVIS recommendation
            date also limits when you can file.
          </p>
        </div>
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
