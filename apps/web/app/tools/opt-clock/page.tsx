    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Initial post-completion OPT allows up to 90 cumulative unemployment days during the authorized EAD period. Calendar days, including weekends, count when there is no qualifying employment. Confirm your dates and employment eligibility with your DSO.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Exceeding the 90-day unemployment limit can affect your F-1 status and future immigration benefits. Contact your DSO or a qualified immigration professional promptly. A calculator cannot determine your legal status or whether your SEVIS record has been terminated.',
        },
      },
    ],
  },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
            Use the 90-day limit carefully
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
