        ...
        tools: [
            {
                ...
                description: "Calculate your I-765 filing window based on your program end date",
    ...
    career: {
        ...
        tools: [
            ...
            },
            {
                ...
                description: "Track applications with Kanban board, table, and calendar views",
            ...
            },
            {
                ...
                description: "Generate ATS-optimized resumes tailored to job descriptions",
            ...
            },
            {
                ...
                description: "Score your resume against ATS systems and get improvement tips",
        ...
        tools: [
            {
                ...
                description: "F-1 student tax resources: Form 8843, 1040-NR, FICA exemption",
...
const TRUST_STATS = [
    {
        value: "2,500+ Students",
        description: "Trusted by international students from 200+ universities",
        icon: Users,
    },
    {
        value: "Free Forever",
        description: "Core tools are free — no credit card, no trial, no tricks",
        icon: CreditCard,
    },
    {
        value: "Built by F-1 Alumni",
        description: "Created by former F-1 students who know the process",
        icon: GraduationCap,
    },
];
        ...
        <>
            ...
            <section className="pt-24 pb-12 sm:pt-28 sm:pb-16 text-center px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        All the free tools international students need to protect OPT status, track deadlines, find H-1B
                        sponsors, and build careers — no signup required for most.
                    </p>
            ...
            <section className="py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto space-y-16">
                    {(Object.entries(TOOLS) as [keyof typeof TOOLS, (typeof TOOLS)[keyof typeof TOOLS]][]).map(
                        ([key, category]) => (
                            <div key={key}>
                                <div
                    ...
                    <div className="grid sm:grid-cols-3 gap-8">
                        {TRUST_STATS.map((stat) => {
                            ...
                            return (
                                <div
                                    key={stat.value}
                                    className="text-center p-6 rounded-xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800"
                                >
                                    <Icon className="w-10 h-10 mx-auto mb-3 text-blue-600 dark:text-blue-400" />
                                    <h3 className="font-bold text-gray-900 dark:text-white mb-1">{stat.value}</h3>
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 sm:p-12 text-white">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Protect Your OPT Status?</h2>
                        <p className="text-blue-100 mb-8 max-w-xl mx-auto">
                            Join 2,500+ F-1 students who trust TrackMyOPT. All core tools are free — no credit card, no
                            trial, no tricks.
                        </p>
                        <Link
                            href="/login"
