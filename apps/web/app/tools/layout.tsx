...
export const metadata: Metadata = {
    ...
    description: "Free OPT and immigration tools regularly used by 10,000+ people. Explore calculators, unemployment tracking, case status, H-1B sponsors, and AI resumes.",
    ...
    openGraph: {
        ...
        description: "10,000+ people regularly use TrackMyOPT free tools: OPT calculators, unemployment tracking, case status, H-1B sponsors, and AI resumes.",
