...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.trackmyopt.com/tools/stem-clock',
    siteName: 'TrackMyOPT',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://www.trackmyopt.com/tools/stem-clock',
  },
};
  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'STEM adds 60 days to the original 90-day allowance, for 150 cumulative days across initial OPT and STEM. It is not a separate 60-day cap on the STEM period. Unused initial OPT days carry into the combined allowance; an earlier initial-OPT violation is not erased.',
        },
      },
      {
        '@type': 'Question',
      ...
      >
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
            Understand the combined limit
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
            STEM OPT adds up to 60 days of unemployment time. Across regular OPT
            and the STEM extension, the combined unemployment limit is 150 days.
            Keep your initial OPT history in mind when planning.
          </p>
        </div>
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
