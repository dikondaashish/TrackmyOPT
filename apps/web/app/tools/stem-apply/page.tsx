...
const jsonLd = {
  ...
  step: [
    ...
    },
    {
      ...
      text: 'Submit Form I-765 under category (c)(3)(C) with the required evidence in the current USCIS instructions. Give Form I-983 to your DSO. File up to 90 days before OPT expires and within 60 days of the SEVIS recommendation, before current authorization expires.',
      position: 5,
    },
  ],
  tool: [
      ...
      >
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
            Confirm STEM OPT eligibility
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
            STEM OPT extension eligibility includes a qualifying STEM degree, an
            E-Verify employer, and a completed Form I-983 training plan. Your
            DSO reviews the information and issues the required I-20
            recommendation.
          </p>
        </div>
        <div className="rounded-xl bg-white/90 p-4 ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-700">
          <h2 className="font-semibold text-slate-950 dark:text-white">
            Build a complete filing plan
          </h2>
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-300">
