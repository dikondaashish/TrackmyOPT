...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        type: "article",
        images: [{ url: "https://www.trackmyopt.com/og-image.jpg", width: 1200, height: 630, alt: "Top H-1B Sponsor Companies 2026: Data-Driven Rankings & Analysis" }],
    },
    ...
    return (
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <header className="mb-12">
                ...
                <div className="mt-6 text-sm text-gray-500">Last updated: May 13, 2026 • Data source: USCIS H-1B Employer Data Hub (FY2025)</div>
            </header>
