...
export default function DriversLicensePage() {
    return (
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <BlogPostSchema title={metadata.title as string} description={metadata.description as string} publishedDate="2026-02-05" modifiedDate="2026-02-05" author="Vinay Kumar" canonicalUrl={metadata.alternates?.canonical as string} />
