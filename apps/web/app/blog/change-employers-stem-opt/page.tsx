  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="relative w-full h-[420px] md:h-[520px] rounded-2xl overflow-hidden mb-12 shadow-xl">
        <BlogPostImage src="/blog/change-employers-stem-opt.png" alt="Two business cards, new Form I-983, employer change checklist in notebook and laptop with email to HR" className="object-cover w-full h-full" sizes="(max-width: 768px) 100vw, 768px" priority />
      </div>
