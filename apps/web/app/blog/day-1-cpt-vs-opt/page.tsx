...
export const metadata: Metadata = {
    ...
    openGraph: { title: "Day 1 CPT vs OPT: Complete Comparison | TrackMyOPT", description: "Understand the key differences between Day 1 CPT and OPT. Eligibility, timeline, work authorization, and how each option affects your F-1 status.", url: "https://www.trackmyopt.com/blog/day-1-cpt-vs-opt", type: "article", siteName: "TrackMyOPT", images: [{ url: "https://www.trackmyopt.com/og-image.jpg", width: 1200, height: 630, alt: "Day 1 CPT vs OPT: Key Differences Every F-1 Student Should Know (2026)" }] },
    alternates: { canonical: "https://www.trackmyopt.com/blog/day-1-cpt-vs-opt" },
    twitter: {
        card: "summary_large_image",
        title: "Day 1 CPT vs OPT: Complete Comparison | TrackMyOPT",
        description: "Understand the key differences between Day 1 CPT and OPT. Eligibility, timeline, work authorization, and how each option affects your F-1 status.",
