  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="relative w-full h-[420px] md:h-[520px] rounded-2xl overflow-hidden mb-12 shadow-xl">
        <img src="/blog/stem-opt-six-month-validation-report.png" alt="STEM OPT reporting calendar with validation deadlines, SEVIS confirmation, and Form I-983" className="object-cover w-full h-full" />
      </div>
