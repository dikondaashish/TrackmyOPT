...
import { Clock, ArrowRight, AlertTriangle, FileText, CheckCircle2, BookOpen, GraduationCap, Briefcase, Building2 } from "lucide-react";
    ...
    return (
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <figure className="mb-12">
                <img
                    src="/blog/cpt-complete-guide.png"
                    alt="University bulletin board with CPT application forms and internship flyers"
