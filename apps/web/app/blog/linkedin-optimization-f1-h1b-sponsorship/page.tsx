...
export default function LinkedInOptimizationPage() {
    return (
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <BlogPostSchema title={metadata.title as string} description={metadata.description as string} publishedDate="2026-04-02" modifiedDate="2026-04-02" author="Vinay Kumar" canonicalUrl={metadata.alternates?.canonical as string} />
            ...
            <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-12 shadow-xl">
                <BlogPostImage src="/blog/linkedin-optimization-f1-h1b-sponsorship.jpg" alt="Laptop showing a LinkedIn profile page with an Open to Work badge next to a resume" className="object-cover w-full h-full" sizes="(max-width: 768px) 100vw, 768px" priority />
            </div>
