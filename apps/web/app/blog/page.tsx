...
const blogPosts = [
    ...
    },
    {
        ...
        description: "Use duties, skills, coursework, and a signed supervisor explanation to document how an OPT job relates to your degree.",
        category: "OPT Employment",
        readTime: "10 min read",
        date: "July 27, 2026",
        tags: ["OPT", "Employment", "Degree Relationship", "F-1"],
        featured: true,
    },
    {
