...
export const metadata: Metadata = {
    ...
    description: "Connect with international students and alumni. Get referrals, interview tips, and visa advice from people who've navigated OPT successfully.",
    ...
    openGraph: {
        title: "TrackMyOPT Community — F-1 Students & Alumni",
        description:
