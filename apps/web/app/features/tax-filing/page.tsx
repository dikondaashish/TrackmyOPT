    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-violet-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
            <FeatureServiceSchema
                ...
                faqItems={[
                  {q: "Do F-1 students have to file U.S. taxes?", a: "Yes. All F-1 students must file Form 8843, even if they had zero income. If you earned any U.S. income (wages, stipends, scholarships above tuition), you must also file Form 1040-NR. Failing to file can create problems for future visa applications."},
                  {q: "What tax forms do I need as an F-1 student?", a: "At minimum, you need Form 8843 (Statement for Exempt Individuals). If you earned income, you also need Form 1040-NR (Nonresident Alien Income Tax Return), your W-2(s) from employers, and potentially Form 1098-T from your university for tuition credits."},
                  {q: "Am I exempt from Social Security and Medicare (FICA) taxes?", a: "F-1 students are generally exempt from FICA taxes (Social Security and Medicare) for the first 5 calendar years in the U.S. If your employer withheld FICA taxes, you may be able to request a refund by filing Form 843 and Form 8316."},
                  {q: "Can I use TurboTax or H&R Block?", a: "Most mainstream tax software doesn't support nonresident alien returns (Form 1040-NR). Specialized tools like Sprintax or Glacier Tax Prep are designed for international students. TrackMyOPT's tax guide helps you understand which tool fits your situation."},
                  {q: "What happens if I don't file taxes?", a: "Failure to file can result in IRS penalties, interest on unpaid taxes, and problems with future immigration applications. USCIS may review your tax history when processing green card or visa applications. Always file at least Form 8843."},
                  {q: "Do I need to file state taxes too?", a: "It depends on your state. Most states with income tax require a separate state return. Some states (like Texas, Florida, Washington) have no state income tax. Check your state's requirements — our tax filing tool helps you determine what's needed."}
                ]}
            />
            <FeatureHero
