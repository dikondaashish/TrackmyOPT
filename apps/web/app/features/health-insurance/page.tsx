    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
            <FeatureServiceSchema
                ...
                faqItems={[
                  {q: "Do F-1 students on OPT need health insurance?", a: "While there's no federal mandate requiring health insurance, being uninsured in the U.S. is extremely risky. A single ER visit can cost $5,000-$50,000+. Most F-1 students lose university coverage after graduation, making it essential to find a replacement plan during OPT."},
                  {q: "Can OPT students get Marketplace (ACA) insurance?", a: "Yes! F-1 students on OPT can enroll in Marketplace plans through Healthcare.gov. Depending on your income, you may qualify for premium tax credits that significantly reduce your monthly cost — potentially to $0/month. Open enrollment runs November through January."},
                  {q: "What is a Special Enrollment Period?", a: "A Special Enrollment Period (SEP) lets you enroll in Marketplace insurance outside of open enrollment. Losing your university health plan qualifies as a life event that triggers a 60-day SEP. You must enroll within 60 days of losing coverage."},
