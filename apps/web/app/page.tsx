...
export const metadata: Metadata = {
  ...
  description:
    'Never miss an OPT deadline. Track filing windows, unemployment days, and STEM dates in one place. Free forever. 3,000+ users have signed up, and 10,000+ people regularly use our free tools.',
};
