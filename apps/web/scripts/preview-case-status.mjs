...
const result = await esbuild.build({
  ...
  stdin: {
    ...
    createRoot(document.getElementById('root')).render(<main style={{width,maxWidth:'100%',margin:'auto',padding:16}} className='space-y-5'>
      ...
      <MonitorHealthStrip caseId='11111111-1111-4111-8111-111111111111' monitorActive={!params.has('free')} lastCheckedAt='2026-09-23T14:00:00Z' emailAlertsEnabled={false}/>
